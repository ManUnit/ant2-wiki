...
published:
created: 2026-05-05
description: "The OWASP CRS is a set of generic attack detection rules for use with ModSecurity or compatible web application firewalls. The CRS aims to protect web applications from a wide range of attacks, including the OWASP Top Ten, with a minimum of false alerts."
tags:
  - "clippings"
---
...
![CRS Logo](https://owasp.org/www-project-modsecurity-core-rule-set/assets/images/logo.png)
