...
| Form factor | Hardware box appliance (built-in) |
| Price | **฿250,000 THB** |
| WAF included | Ant2 WAF pre-installed |
| Origin | Thailand 🇹🇭 — developed and manufactured locally |

The appliance ships with Ant2 WAF pre-configured inside **Ant2Cloud** — a turnkey security gateway requiring no external software installation. Target customers: enterprises and organizations that require on-premise, hardware-grade WAF security with a local Thai support chain.

## Current Version

**v2.4.26** (as of 2026-05-13)

| Server | Version | Path |
|--------|---------|------|
| `172.20.20.180` | v2.4.15 | `/opt/ant2-proxy/` |
| `172.20.20.181` | v2.4.26 | `/opt/ant2-proxy/` |
| `192.168.0.238` | v2.4.15 | `/opt/nginx-gui/` |

> [!warning] Server fleet partially deployed: 172.20.20.181 is on v2.4.26; 172.20.20.180 and 192.168.0.238 still on v2.4.15.

Previous: v2.4.11 → v2.4.12 → v2.4.13 → v2.4.14 → v2.4.15 → … → v2.4.26
